...
public class AddHomework extends ActionBarActivity {
    ...
    private Button addAssignment, clear;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                VariableDB.clearALL(AddHomework.this);
                Toast.makeText(AddHomework.this, "Cleared", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                try {
                    ...
                    if (new Date().after(strDate)) {
                        ...
                        if (assignmentName.getText().toString().equals("")) {
                            ...
                            if(VariableDB.getList(AddHomework.this) == null){
                                //Create new set
                                Set<String> set = new HashSet<String>();
                                checkDate = "/" + checkDate;
                                set.add(assignmentName.getText().toString() + " " + checkDate);
                                VariableDB.setList(AddHomework.this, set);
                                Toast.makeText(AddHomework.this, "Array was empty, new item added", Toast.LENGTH_SHORT).show();
                            }else{
                                //There is an existing set...
                                Set<String> set = VariableDB.getList(AddHomework.this);
                                ArrayList<String> mainList = new ArrayList<String>();
                                checkDate = "/" + checkDate;
                                mainList.add(assignmentName.getText().toString() + " " + checkDate);
                                set.addAll(mainList);
                                VariableDB.setList(AddHomework.this, set);
                                Toast.makeText(AddHomework.this, "Array already had an item, new item added", Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
